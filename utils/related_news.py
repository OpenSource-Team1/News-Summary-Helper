...
import numpy as np
def step1(title, topic):
    # ✅ 예시 기사 리스트 (딕셔너리 리스트)
    sql = "SELECT * FROM related_news where DATE = '" + getCorrectTime() + "' AND category = '" + ... + "';"
    # sql = "SELECT * FROM related_news where DATE = '2025-06-02' AND category = '" + topic + "';"
